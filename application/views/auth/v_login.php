...
<head>
    ...
    <style>
        body {
            background-image: url("http://localhost/GKIPerumnas/resources/img/slide/gedungbaruu.png");
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <b>Admin</b> Innovate Xpress Management
        </div>
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?php echo base_url() . 'login/4dm1n/verification' ?>" method="post">
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo base_url(); ?>resources/back/dist/js/adminlte.min.js"></script>
