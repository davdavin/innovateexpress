...
class Login extends CI_Controller
{
  ...
  public function validasi()
  {
    ...
    $cek_login = $this->M_Profil->cek_login('user', $where)->row_array();

    if (password_verify($password, $cek_login['password']) && $cek_login) {
      ...
      $this->session->set_flashdata('gagal', 'Username or Password incorrect');
      redirect('login/4dm1n');
    }
  }
  ...
  /* function forgot_password()
    {
        ...
        $link = base_url() . 'jemaat/change_password/' . md5($email);
